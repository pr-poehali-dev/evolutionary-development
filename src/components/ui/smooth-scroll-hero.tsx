        ...
        >
          <div className="text-center text-white max-w-4xl mx-auto px-6">
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-gray-200 mb-8 leading-relaxed font-medium">
              Расскажите о вашем бренде — мы предложим решение,
              <br className="hidden md:block" />
              которое выделит вас среди конкурентов навсегда.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
              ...
              <div className="text-center">
                ...
                <div className="text-xs md:text-sm text-gray-300 font-medium">Стран мира</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-2xl md:text-3xl font-black text-white mb-1">40+</div>
                <div className="text-xs md:text-sm text-gray-300 font-medium">Наград</div>
              </div>
            </div>
            ...
            <div className="mt-12 pt-6 border-t border-white/20">
              <p className="text-xs text-gray-400 mb-3 font-medium">НАМ ДОВЕРЯЮТ КРУПНЫЕ БРЕНДЫ</p>
              <div className="flex flex-wrap justify-center items-center gap-4 text-gray-300">
                <span className="text-xs font-semibold">СТРАТЕГИЯ</span>
                <span className="text-xs font-semibold">АЙДЕНТИКА</span>
                <span className="text-xs font-semibold">БРЕНДБУК</span>
                <span className="text-xs font-semibold">УПАКОВКА</span>
              </div>
            </div>
          </div>
        </motion.div>
